...
from derpy.derpy_conf import NRRP_ZABER_PORT
...
N_MEASUREMENTS = 50
DATA_PATH = Path.home() / "Data/Derpy/09-09-2026/NRRP_Air_Cal"
TINT = 2 # milliseconds
FPS = 200
...
if __name__ == "__main__":
    ...
    cam = CRED2(set_temperature=-40, tint=TINT, fps=FPS)
    ...
    zaber_connection = ZaberConnection(NRRP_ZABER_PORT)
